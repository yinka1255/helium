	...
	<div class="main-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<br/><br/>
				<form role="form" method="post" action="{{url('admin/update_class')}}" class="form-horizontal ">
					{{ csrf_field() }}
					<input type="hidden" name="id" value="{{$class->id}}" />
					<div class="form-group">
						<label for="field-2" class="col-sm-2 control-label">Name</label>
						<div class="col-sm-5">
							<input type="text" name="name" value="{{$class->name}}"  class="form-control" placeholder="Name" required>
						</div>
					</div>
					<div class="form-group">
